    ...
    <ul role="list"
      ...
      {projects.map(project => (
        <Link to={project.route}
              className="min-w-96 sm:min-w-72  col-span-1 flex overflow-hidden max-w-mbd flex-col divide-y rounded-lg text-center shadow backdrop-blur bg-gray-800/5 ring-1 ring-white/10 transition-all duration-500 ease-in-out transform hover:scale-105 hover:ring-2 hover:ring-white"
              key={project.name}>
